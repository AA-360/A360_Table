...
public final class ListToHeadersCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(ListToHeadersCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    ListToHeaders command = new ListToHeaders();
    ...
    try {
      Optional<Value> result =  Optional.ofNullable(command.action((Table)convertedParameters.get("Tabela"),(List<Value>)convertedParameters.get("lista")));
