...
public final class ClearTableCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(ClearTableCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    ClearTable command = new ClearTable();
    ...
    try {
      command.action((Table)convertedParameters.get("Tabela"));Optional<Value> result = Optional.empty();
