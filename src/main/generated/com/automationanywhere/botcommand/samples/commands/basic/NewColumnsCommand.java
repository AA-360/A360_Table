...
public final class NewColumnsCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(NewColumnsCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    NewColumns command = new NewColumns();
